...
from api.views import Graficas, Home, LoginView, obtener_respuesta_chatgpt
...
urlpatterns = [
    ...
    path('obtener-respuesta-chatgpt/', obtener_respuesta_chatgpt, name='obtener_respuesta_chatgpt'),
]
